	...
	<div class="container">
		<div id="main" class="inner">
			...
			switch( $category->slug ) {
				...
				case 'interviews':
				default:
					$category_order = array('interviews', 'news', 'reviews', 'opinions');
					break;
			}
			...
			foreach( $category_order as $cat_group ) {
				...
				if( $cat_group == 'news' ) {
					?>
					<section class="main-group main-group-5" id="news">
						<h2 class="main-group-title cat-news">News</h2>
						<a href="<?php echo get_category_link( get_cat_ID( 'news' ) ); ?>" class="main-group-more">More News</a>
						<ul class="main-group-items">
				...
				if( $cat_group == 'reviews' ) {
					?>
					<section class="main-group main-group-4" id="reviews">
						<h2 class="main-group-title cat-reviews">Reviews</h2>
						<a href="<?php echo get_category_link( get_cat_ID( 'reviews' ) ); ?>" class="main-group-more">More Reviews</a>
						<ul class="main-group-items">
